...
#do_install[mcdepends] += "multiconfig::tpp-${MACHINE}:img-sp-ncnn:do_image_complete"
...
# SDK
do_populate_sdk[mcdepends] += "multiconfig::tpp-${MACHINE}:img-sp-tssz:do_populate_sdk"
