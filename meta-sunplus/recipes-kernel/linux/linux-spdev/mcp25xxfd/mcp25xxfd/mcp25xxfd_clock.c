...
dev_err( &spi->dev, "%s() %d priv->config.clock_pll:%d\n", __FUNCTION__, __LINE__, priv->config.clock_pll);
...
dev_err( &spi->dev, "%s() %d priv->clock_freq:%d\n", __FUNCTION__, __LINE__, priv->clock_freq);
...
dev_err( &spi->dev, "%s() %d spi_setup_speed_hz:%d\n", __FUNCTION__, __LINE__, priv->spi_setup_speed_hz);

	/* normal operation clock speeds */
	priv->spi_normal_speed_hz = priv->clock_freq / 2;
dev_err( &spi->dev, "%s() %d spi_normal_speed_hz:%d\n", __FUNCTION__, __LINE__, priv->spi_normal_speed_hz);
	if (priv->config.clock_div2) {
dev_err( &spi->dev, "%s() %d divider!\n", __FUNCTION__, __LINE__);
	 ...
	 */
	priv->spi_use_speed_hz = priv->spi_setup_speed_hz;
dev_err( &spi->dev, "%s() %d spi_use_speed_hz:%d\n", __FUNCTION__, __LINE__, priv->spi_use_speed_hz);
dev_err( &spi->dev, "%s() %d spi_setup_speed_hz:%d\n", __FUNCTION__, __LINE__, priv->spi_setup_speed_hz);
dev_err( &spi->dev, "%s() %d spi_normal_speed_hz:%d\n", __FUNCTION__, __LINE__, priv->spi_normal_speed_hz);
