#ifndef __REG_HDMI_TX_H__
#define __REG_HDMI_TX_H__

#include <mach/io_map.h>

typedef volatile struct reg_hdmi_tx_s
{
    // GROUP 380 HDMI G0
...
#define HDMI_TX_REGISTER_OFFSET VA_IOB_ADDR(0xbe00)
#define hdmi_tx_regs ((volatile reg_hdmi_tx_t *) HDMI_TX_REGISTER_OFFSET)
#define MOON4_REG ((volatile reg_moon4_t *) MOON4_REGISTER_OFFSET)

#endif // end of #ifndef __REG_HDMI_TX_H__