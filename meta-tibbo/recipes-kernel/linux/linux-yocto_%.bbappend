...
KBRANCH_tppg1 = "standard/beaglebone"
KBRANCH_tppg2 = "standard/base"
# later: add pentagram patches to the Yocto kernel tree and set
#KBRANCH_tppg2 = "standard/pentagram"
...
# 4.12.14 !
SRCREV_machine_tppg1 ?= "9cc6b0ae1aad7312e85ac4134398f81c0140de33"
SRCREV_machine_tppg2 ?= "1348b764f8ca8803b6b833c69f5cb795fddf24b8"
SRCREV_meta ?= "cebe198870d781829bd997a188cc34d9f7a61023"
LINUX_VERSION_tppg1 = "4.12.28"

## 4.12.14 !
#SRCREV_machine ?= "bcd502e07fa1948ec674d1fc8d1e69db32082c72"
#SRCREV_machine_tppg2 ?= "1348b764f8ca8803b6b833c69f5cb795fddf24b8"
#SRCREV_meta ?= "cebe198870d781829bd997a188cc34d9f7a61023"
...
#SRC_URI_append_tppg1 += "file://omap_fbdev.c.patch"

# SRC_URI_append_tppg1 += "file://tilcdc.1.dbg.patch"
# SRC_URI_append_tppg1 += "file://tilcdc.2.dbg.patch"
# SRC_URI_append_tppg1 += "file://tilcdc.3.dbg.patch"
# SRC_URI_append_tppg1 += "file://tilcdc.4.dbg.patch"
# SRC_URI_append_tppg1 += "file://tilcdc.5.dbg.patch"
# SRC_URI_append_tppg1 += "file://tilcdc.6.dbg.patch"
...
#KERNEL_FEATURES_append_tppg1 += " cfg/ovls/ovls.scc"
KERNEL_FEATURES_append_tppg1 += " features/media/media-usb-webcams.scc"
KERNEL_FEATURES_append_tppg2 += " features/media/media-usb-webcams.scc"
KERNEL_FEATURES_append_tppg1 += " features/netfilter/netfilter.cfg"
KERNEL_FEATURES_append_tppg2 += " features/netfilter/netfilter.cfg"
KERNEL_FEATURES_append_tppg1 += " features/usb/serial-all.scc"
KERNEL_FEATURES_append_tppg2 += " features/usb/serial-all.scc"
KERNEL_FEATURES_append_tppg1 += " cfg/rpi-ovls/ovls.scc"
#KERNEL_FEATURES_append_tppg2 += " cfg/rpi-ovls/ovls.scc"
