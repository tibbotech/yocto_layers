DESCRIPTION = "Read/write register module"
...
do_install() {
 ...
 install -m 0644 ${S}/write_cm${KERNEL_OBJECT_SUFFIX} ${D}${base_libdir}/modules/${KERNEL_VERSION}/extra/
}
